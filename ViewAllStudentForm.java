...
public class ViewAllStudentForm extends JFrame {
    ...
    public ViewAllStudentForm(StudentCollection studentCollection) {
        setSize(700, 400);
        ...
        // Title Label
        lblTitle = new JLabel("View Student Details");
    ...
    public void reloadTable() {
        dtm.setRowCount(0);
        Student[] studentArray = studentCollection.getAllCustomers();

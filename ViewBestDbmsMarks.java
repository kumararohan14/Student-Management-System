...
public class ViewBestDbmsMarks extends JFrame {
    ...
    public ViewBestDbmsMarks(StudentCollection studentCollection) {
        setSize(700, 400);
        ...
        // Title Label
        lblTitle = new JLabel("View Best in DBMS Marks Details");
    ...
    public void reloadTable() {
        dtm.setRowCount(0);
        Student[] studentArray = studentCollection.sortStudentArrayAccorToDbms();
